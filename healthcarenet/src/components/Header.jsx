...
const Header = () => {
  return (
    <div className=" mt-10 mx-20 flex flex-col md:flex-row flex-wrap bg-blue-600 rounded-lg px-6 md:px-10 lg:px-20  ">
      <div className="md:w-1/2 flex flex-col items-start gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        ...
        <a
          href=""
          className="flex items-center  bg-white rounded-full text-gray-600   m-auto hover:scale-105 transition-all duration-300 w-06 h-20 text-lg pl-4 ml-0 mt-5"
        >
